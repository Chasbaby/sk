...
public interface BaseMapperPlus<M,T,V> extends BaseMapper<T> {
    Logger log = LoggerFactory.getLogger(BaseMapperPlus.class);
    ...
    default boolean insertBatch(Collection<T> entityList, int batchSize) {
        ...
        return SqlHelper.executeBatch(this.currentModelClass(), (Log) log, entityList, batchSize,
    ...
    default boolean updateBatchById(Collection<T> entityList, int batchSize) {
        ...
        return SqlHelper.executeBatch(this.currentModelClass(), (Log) log, entityList, batchSize,
                (sqlSession, entity) -> {
                    ...
                    param.put(Constants.ENTITY, (T) entity);
    ...
    default boolean insertOrUpdateBatch(Collection<T> entityList, int batchSize) {
        ...
        return SqlHelper.saveOrUpdateBatch(this.currentModelClass(), this.currentMapperClass(), (Log) log, entityList, batchSize, (sqlSession, entity) -> {
