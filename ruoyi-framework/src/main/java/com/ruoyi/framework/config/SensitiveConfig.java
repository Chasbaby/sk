...
public class SensitiveConfig {
    private static final Logger logger = LoggerFactory.getLogger(SensitiveConfig.class);
    /**
     * 敏感词文件
     */
    @Autowired
    ...
    @PostConstruct
    public void init() {
        List<SysSensitive> sensitives = sysSensitiveService.selectAll();
        sensitives.stream().forEach(item->{
            this.addKeyword(item.getSensitiveWord());
        });
        logger.info("敏感词加载成功");
